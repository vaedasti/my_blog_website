			...
			<div class="col-lg-12 col-sm-6 col-lg-offset-0 col-sm-offset-3">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="onaylanmamis">
						<?php
							$yorumlar = sorgu_calistir("SELECT y.id AS id, k.ad AS ad, k.soyad AS soyad, y.icerik AS icerik, y.tarih AS tarih, y.onay AS onay FROM yorumlar AS y INNER JOIN kullanicilar AS k ON y.kullanici=k.id INNER JOIN gonderiler AS g ON y.gonderi=g.id WHERE onay=0", 2);
						?>
						<div class="card">
												...
												<table id="datatables" class="table table-striped table-no-bordered table-hover dataTable dtr-inline" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
													<thead>
														<tr role="row">
															...
															<th class="disabled-sorting" tabindex="3" aria-controls="datatables" rowspan="1" colspan="1" style="width: 150px;">Tarih</th>
		      ...
		      <!--  end card  -->
					...
					<div class="tab-pane" id="onaylanmis">
						<?php
							$yorumlar = sorgu_calistir("SELECT y.id AS id, k.ad AS ad, k.soyad AS soyad, y.icerik AS icerik, y.tarih AS tarih, y.onay AS onay FROM yorumlar AS y INNER JOIN kullanicilar AS k ON y.kullanici=k.id INNER JOIN gonderiler AS g ON y.gonderi=g.id WHERE onay=1", 2);
						?>
						<div class="card">
		          <div class="card-header card-header-icon" data-background-color="purple">
		            <i class="material-icons">comment</i>
												...
												<table id="datatables" class="table table-striped table-no-bordered table-hover dataTable dtr-inline" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
													...
													<tbody>
														...
														<tr role="row" class="odd">
															...
															<td><?php print $yorum['tarih']; ?></td>
															<td class="td-actions text-right">
																<button type="button" rel="tooltip" class="btn btn-warning btn-icon edit" data-original-title="Onayı Kaldır" title="" onclick="demo.showSwal('basic')">
																	<i class="material-icons">done</i>
																	<div class="ripple-container"></div>
																</button>
																<button type="button" rel="tooltip" class="btn btn-danger btn-icon remove" data-original-title="Sil" title="" onclick="demo.showSwal('yorum-sil')">
																...
																<button type="button" rel="tooltip" class="btn btn-icon" data-original-title="Sayfada Aç" title="" onclick="demo.showSwal('basic')">
																	<i class="material-icons">close</i>
																	<div class="ripple-container"></div>
																</button>
															</td>
